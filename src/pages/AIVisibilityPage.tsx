  ...
  return (
    <div className="bg-gray-950 text-gray-100">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-5 pt-32 pb-20 sm:pt-40 sm:pb-28 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-500/10 border border-blue-500/20 rounded-full mb-8">
            ...
            <span className="text-xs font-semibold text-blue-300 tracking-wide uppercase">AI Visibility Service</span>
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1] text-white mb-6">
            Become the Business{' '}
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">AI Recommends</span>
          </h1>
          <p className="max-w-2xl mx-auto text-lg sm:text-xl text-gray-400 leading-relaxed mb-10">
            ...
            <span className="text-gray-200 font-medium">"Who's the best [service] near me?"</span>{' '}
            and get one answer. Hybrid Ads makes sure that answer is you.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => navigate('ai-score')}
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-600/25 text-base"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-4 border border-gray-700 text-gray-300 hover:text-white hover:border-gray-500 font-semibold rounded-xl transition-colors text-base"
            >
              See how it works
              <ArrowRight className="w-4 h-4" />
            </button>
      ...
      <section className="max-w-4xl mx-auto px-5 pb-20">
        <article className="bg-gray-900 border border-gray-800 rounded-2xl p-8 sm:p-10">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-5">What is AI Visibility?</h2>
          <p className="text-base sm:text-lg text-gray-300 leading-relaxed">
            ...
            <em className="text-white font-medium not-italic">the source the AI trusts and names in its answer.</em>{' '}
      ...
      {/* ── HOW IT WORKS ── */}
      <section id="how-it-works" className="bg-gray-900/50 border-y border-gray-800/60 py-24">
        <div className="max-w-5xl mx-auto px-5">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">How Hybrid Ads Makes You the Answer</h2>
            <p className="text-gray-400 max-w-xl mx-auto">Three steps to move from invisible to recommended.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={item.step}
                className="bg-gray-900 border border-gray-800 rounded-2xl p-7 hover:border-gray-700 transition-colors group"
              >
          ...
          <div className="text-center mt-12">
            <button
              onClick={() => navigate('ai-score')}
              className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-600/25"
            >
      ...
      <section className="max-w-5xl mx-auto px-5 py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 lg:p-10">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center">
                <Database className="w-5 h-5 text-white" />
              </div>
              <div>
                <p className="text-sm font-bold text-white">Knowledge Catalog</p>
            ...
            <div className="space-y-3">
              {['Pricing Data', 'Service Areas', 'Customer FAQs', 'Credentials', 'Reviews', 'Schema Markup'].map(
                (label, i) => (
                  <div
                    key={label}
                    className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 border border-gray-700/50 rounded-lg"
                  >
                    <div
            ...
            <div className="mt-6 pt-5 border-t border-gray-800">
              <p className="text-sm text-gray-200 font-semibold text-center">
                ...
                <br />
                <span className="text-blue-400">Tomorrow, your knowledge catalog is the foundation.</span>
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ── COMPARISON TABLE ── */}
      <section className="bg-gray-900/50 border-y border-gray-800/60 py-24">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="text-3xl sm:text-4xl font-bold text-white text-center mb-12">The Old Way vs. The New Way</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr>
                  <th className="py-4 px-5 text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-gray-800 w-1/3" />
                  <th className="py-4 px-5 text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-gray-800 w-1/3">
                    Old Way (SEO)
                  </th>
                  <th className="py-4 px-5 text-xs font-semibold text-blue-400 uppercase tracking-wider border-b border-gray-800 bg-blue-500/5 w-1/3">
              ...
              <tbody className="text-sm">
                {[
                  ...
                  <tr key={i} className="border-b border-gray-800/60 hover:bg-gray-800/20 transition-colors">
                    <td className="py-4 px-5 font-semibold text-gray-300">{label}</td>
                    <td className="py-4 px-5 text-gray-400">{old}</td>
                    <td className="py-4 px-5 text-blue-300 font-medium bg-blue-500/5">{neo}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-500/10 border border-blue-500/20 rounded-full mb-6">
              ...
              <span className="text-xs font-semibold text-blue-300 uppercase tracking-wide">The Hybrid Advantage</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
            ...
            <p className="text-base text-gray-300 leading-relaxed mb-8">
              Hybrid Ads is an <strong className="text-white">AI Systems Integrator and Paid Ads Agency</strong> — we don't just advise on this shift, we build the systems and run the campaigns.
            </p>
            <button
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.title} className="bg-gray-900 border border-gray-800 rounded-xl p-6 flex items-start gap-4 hover:border-gray-700 transition-colors">
        ...
        <div className="max-w-3xl mx-auto px-5">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-500/10 border border-blue-500/20 rounded-full mb-6">
              ...
              <span className="text-xs font-semibold text-blue-300 uppercase tracking-wide">FAQ</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white">AI Visibility: Frequently Asked Questions</h2>
          </div>
          ...
          <div className="space-y-6">
            {[
              ...
              <article key={q} className="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition-colors">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-5 text-center">
          ...
          <p className="text-base text-gray-400 leading-relaxed mb-10 max-w-2xl mx-auto">
          ...
          <button
            onClick={() => navigate('ai-score')}
            className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-600/25 text-base mb-8"
          >
            Get Your Free AI Visibility Check
            <ArrowRight className="w-4 h-4" />
          </button>
          <div className="flex items-center justify-center gap-4 text-sm text-gray-500">
            <a href="mailto:hello@hybridads.ai" className="hover:text-gray-300 transition-colors">
              hello@hybridads.ai
            </a>
